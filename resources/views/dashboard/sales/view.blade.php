        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li><a href="{{ route('sales.index') }}" class="text-primary">{{
                            $parent
                            }}</a> /</li>
        ...
        <div class="flex flex-col gap-10">
            ...
            <div
                ...
                <div class="flex flex-col">
                    <h2 class="mb-2.5 font-semibold text-title-md3">Sale Detail</h2>
                    <table class="mb-2.5">
                        <tr>
                            <td>Sale By</td>
                    ...
                    <h2 class="mb-2.5 mt-2.5 font-semibold text-title-md3">Sale Item List</h2>
                    <table class="mb-2.5">
                        <tr>
                            <th>No</th>
                            <th>Item Name</th>
                        ...
                        <tr>
                            ...
                            <td>{{ $saleDetail['inventory']['price']}}</td>
                            <td>{{ $saleDetail['qty'] }}</td>
                            <td>{{ "Rp " . number_format($saleDetail['inventory']['price'] * $saleDetail['qty'],
                                2,",",".") }}
                            </td>
                        </tr>
                        @endforeach
